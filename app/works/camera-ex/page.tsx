        ...
        <main>
          <div className="bg-white px-6 pb-10 pt-2">
            ...
            <div id="ColGridContainer" className="mt-5">
              ...
              <iframe id="b6" className="w-fit h-185" style={{ border: "1px solid rgba(0, 0, 0, 0.1)" }} width={800} height={450} src="https://embed.figma.com/proto/3ZrfUTVqkPKFEPh7idjuOm/Exercise-2?node-id=292-71&scaling=scale-down&content-scaling=fixed&page-id=7%3A3&starting-point-node-id=291%3A105&embed-host=share" sandbox="allow-same-origin allow-scripts allow-presentation" allowFullScreen></iframe>
            </div>
          </div>
